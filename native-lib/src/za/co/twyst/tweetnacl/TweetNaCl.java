...
public class TweetNaCl {
     ...
     * <p>
     * Encrypts a message using a secret key and a nonce. The returned ciphertext is the the plaintext
     * XOR with the output of the stream generated by <code>crypto_stream</code> with the secret key 
     * and nonce.  
     * 
     * @param message
     *          message to encrypt
