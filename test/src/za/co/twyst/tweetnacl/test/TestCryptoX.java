...
//
//assertTrue( "Invalid crypttext", Arrays.equals(crypttext, tweetnacl.cryptoStreamXor2(message, nonce, key)));
//    }
//
...
//            
//            byte[] p = tweetnacl.cryptoStreamXor (message,nonce,key);
//            byte[] q = tweetnacl.cryptoStreamXor2(message,nonce,key);
//
...
//                p = tweetnacl.cryptoStreamXor(message,nonce,key);
//            }
//            
...
//
//            for (int j=0; j<1024; j++) {
//                q = tweetnacl.cryptoStreamXor2(message,nonce,key);
//            }
//
