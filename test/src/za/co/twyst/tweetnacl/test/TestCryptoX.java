...
//
//assertTrue("Invalid crypttext",Arrays.equals(crypttext,tweetnacl.cryptoSecretBoxX(plaintext, nonce, key)));
//    }
//
...
//            byte[] messagez = new byte[message.length + TweetNaCl.SECRETBOX_ZEROBYTES];
//
//            random.nextBytes(key);
//            random.nextBytes(nonce);
//            random.nextBytes(message);
//            
//            java.util.Arrays.fill(messagez, (byte) 0x00);
//            System.arraycopy(message,0,messagez,TweetNaCl.BOX_ZEROBYTES,message.length);
//            
//            byte[] p = tweetnacl.cryptoSecretBox (messagez,nonce, key);
//            byte[] q = tweetnacl.cryptoSecretBoxX(message, nonce, key);
//
//            assertTrue("OOOOPS !",Arrays.equals(Arrays.copyOfRange(p,TweetNaCl.SECRETBOX_BOXZEROBYTES,p.length),q));
//        }
//    }
//
...
//                p = tweetnacl.cryptoSecretBox (messagez,nonce, key);
//            }
//            
...
//
//            for (int j=0; j<1024; j++) {
//                q = tweetnacl.cryptoSecretBoxX(message, nonce, key);
//            }
//
