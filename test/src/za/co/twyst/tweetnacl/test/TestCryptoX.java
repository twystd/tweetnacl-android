...
//
//assertTrue( "Invalid crypttext", Arrays.equals(crypttext, tweetnacl.cryptoStreamSalsa20XorX(message, nonce, key)));
//    }
//
...
//            
//            byte[] p = tweetnacl.cryptoStreamSalsa20Xor (message,nonce,key);
//            byte[] q = tweetnacl.cryptoStreamSalsa20XorX(message,nonce,key);
//
...
//                p = tweetnacl.cryptoStreamSalsa20Xor(message,nonce,key);
//            }
//            
...
//
//            for (int j=0; j<1024; j++) {
//                q = tweetnacl.cryptoStreamSalsa20XorX(message,nonce,key);
//            }
//
