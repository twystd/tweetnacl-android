...
//
//assertTrue("Invalid crypttext",Arrays.equals(crypttext,tweetnacl.cryptoSecretBox2(plaintext, nonce, key)));
//    }
//
...
//
//            byte[] p = tweetnacl.cryptoSecretBox (message,nonce,key);
//            byte[] q = tweetnacl.cryptoSecretBox2(message,nonce,key);
//
...
//                p = tweetnacl.cryptoSecretBox (message,nonce,key);
//            }
//            
...
//
//            for (int j=0; j<1024; j++) {
//                q = tweetnacl.cryptoSecretBox2(message,nonce,key);
//            }
//
