...
public class TestOther extends TweetNaClTest { 
     ...
     * <p>
     * <code>randombytes</code> uses <code>/dev/urandom</code> so this just a
     * quick check to make sure it vaguely works i.e. doesn't crash and the data
     * looks vaguely random.
     */
