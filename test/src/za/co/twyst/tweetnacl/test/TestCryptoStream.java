...
public class TestCryptoStream extends TweetNaClTest { 
    ...
    /**
     * crypto_stream (adapted from tests/stream3.c)
     * 
     */
    ...
    /**
     * crypto_stream_xor (adapted from tests/stream4.c)
     * 
     */
    public void testCryptoStreamXor() throws Exception {
        final byte[] message = { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, 
        ...
        final byte[] crypttext = { (byte) 0xee, (byte) 0xa6, (byte) 0xa7, (byte) 0x25, 
                                   (byte) 0x1c, (byte) 0x1e, (byte) 0x72, (byte) 0x91, 
                                   (byte) 0x6d, (byte) 0x11, (byte) 0xc2, (byte) 0xcb, 
                                   (byte) 0x21, (byte) 0x4d, (byte) 0x3c, (byte) 0x25, 
                                   (byte) 0x25, (byte) 0x39, (byte) 0x12, (byte) 0x1d, 
        ...
        assertTrue( "Invalid crypttext", Arrays.equals(crypttext, tweetnacl.cryptoStreamXor(message, nonce, key)));
    }
    ...
    /**
     * crypto_stream_salsa20_xor (adapted from
     * http://cr.yp.to/highspeed/naclcrypto-20090310.pdf, page 21 and
     * tests/stream4.c)
     * 
     */
    public void testCryptoStreamSalsa20Xor() throws Exception {
        final byte[] message = { (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
        ...
        final byte[] crypttext = { (byte) 0xee, (byte) 0xa6, (byte) 0xa7,
                ...
                (byte) 0xa4, (byte) 0xc8, (byte) 0xcf, (byte) 0xf8,
                (byte) 0x80,
