...
public class TestCryptoHash extends TweetNaClTest 
       { // CONSTANTS
         ...
         /** crypto_hashblocks
          *  <p>
          *  No idea how to test crypto_hashblocks (and a quick search of the various other ports on github suggests
          *  that nobody else does either). Presumably it works since crypto_hash returns the correct SHA-512 hash 
          *  and uses crypto_hashlocks internally.
          */
