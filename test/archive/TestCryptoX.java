...
//
//assertTrue( "Invalid plaintext", Arrays.equals(plaintext, tweetnacl.cryptoSecretBoxOpenX(ciphertext, nonce, key)));
//    }
//
...
//            byte[] ciphertextz = new byte[ciphertext.length + TweetNaCl.SECRETBOX_BOXZEROBYTES];
//            
//            Arrays.fill      (ciphertextz,(byte) 0x00);
//            System.arraycopy(ciphertext, 0,ciphertextz,TweetNaCl.SECRETBOX_BOXZEROBYTES,ciphertext.length);
//
//            byte[] p = tweetnacl.cryptoSecretBoxOpen (ciphertextz,nonce, key);
//            byte[] q = tweetnacl.cryptoSecretBoxOpenX(ciphertext, nonce, key);
//
//            assertTrue("OOOOPS !",Arrays.equals(Arrays.copyOfRange(p,TweetNaCl.SECRETBOX_ZEROBYTES,p.length),q));
//        }
//    }
//
...
//                p = tweetnacl.cryptoSecretBoxOpen (ciphertextz,nonce, key);
//            }
//            
...
//
//            for (int j=0; j<1024; j++) {
//                q = tweetnacl.cryptoSecretBoxOpenX(ciphertext,nonce, key);
//            }
//
